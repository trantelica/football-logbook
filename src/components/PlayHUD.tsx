...
export function PlayHUD() {
  ...
  return (
    <div
      className="flex flex-wrap items-center gap-x-5 gap-y-2 border-b bg-card px-4 py-1.5 sm:py-2.5"
    ...
    >
      ...
      <div className="flex flex-wrap items-baseline gap-x-4 gap-y-0.5 sm:gap-y-1">
        {has(c.qtr) && (
